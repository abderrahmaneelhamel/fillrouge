...
<div class="bg-gray-50 flex flex-wrap w-full">
...
<button data-modal-target="authentication-modal{{ $event->id }}" data-modal-toggle="authentication-modal{{ $event->id }}" class="button4" type="button">
  ...
  <!-- Main modal -->
  <div id="authentication-modal{{ $event->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full lg:p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
          <!-- Modal content -->
...
<div class="min-w-screen h-screen overflow-y-scroll flex items-center justify-center lg:px-5 pb-10 mt-24">
