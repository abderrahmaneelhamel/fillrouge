<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Once your donation is deleted, all of its resources and data will be permanently deleted. Before deleting your donation, please download any data or information that you wish to retain.') }}
        </p>
    </header>
